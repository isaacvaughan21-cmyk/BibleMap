...
{/* Image suggestion — sample verse map.
    alt="Verse map of Philippians 2:5 with branches for translation comparison, key words, cross-references, and open questions" */}
