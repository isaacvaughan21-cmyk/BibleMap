...
/**
 * Map-of-the-Day chrome — same quiet nav + shared Footer as the Journal.
 * Pages set their own metadata; this layout only provides structure.
 */
export default function MapOfTheDayLayout({
  children,
}: {
  ...
  return (
    <>
      ...
      <main className="relative min-h-dvh pt-16">
        <div
