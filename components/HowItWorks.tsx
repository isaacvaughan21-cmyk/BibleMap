          ...
          {steps.map((step, i) => (
            <Reveal key={step.num} delay={0.15 + i * 0.15}>
              <div className="group">
                ...
                <span
                  aria-hidden="true"
                  className="mt-3 block h-px w-10 bg-gold/40 transition-all duration-500 group-hover:w-20 group-hover:bg-gold/70"
                />
                ...
                <span className="mt-6 inline-flex items-center gap-2 rounded-full border border-rule bg-parchment px-4 py-2 font-sans text-xs text-ink-soft transition-colors duration-300 group-hover:border-gold/50">
