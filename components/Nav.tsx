  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-rule/60 bg-parchment/70 backdrop-blur-md">
      ...
      >
        ...
        {/* Right: map-of-the-day + journal + waitlist links + try-free pill */}
        <div className="flex items-center gap-6">
          <Link
            href="/map-of-the-day"
            className="group relative hidden font-sans text-xs tracking-eyebrow text-ink-muted transition-colors hover:text-ink md:inline-block"
          >
            MAP OF THE DAY
            <span
              aria-hidden="true"
